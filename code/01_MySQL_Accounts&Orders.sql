...
CREATE TABLE Person (
	...
	Address VARCHAR(64),
	City VARCHAR(64),
	State ENUM('AK','AL','AR','AZ','CA','CO','CT', #ENUM for valid state/territory/base abbreviations
	...
	#check that zip/phone are all digits?
);

CREATE TABLE Customer (
	AccountID INT,
	Email VARCHAR(64) NOT NULL,
	AccountType ENUM('Limited', 'Unlimited', 'Unlimited+', 'Unlimited++') NOT NULL DEFAULT 'Limited',
	AccountCreated DATE,
	...
	#Check that CC# is all numbers
	#Check that email is LIKE '%@%.%'
);
